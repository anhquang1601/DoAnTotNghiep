...
router.post("/student/:idRoom",async(req,res)=>{
...
//post priorityObject
router.post("/priorityObject/:id",async(req,res)=>{
...
//post kinkroom
router.post("/Kindroom/",async(req,res)=>{
...
//post room
router.post("/room/:idKindroom",async(req,res)=>{
...
//post billroom
router.post("/billroom",async(req,res)=>{
...
//post servicebill
router.post("/servicebill",async(req,res)=>{
...
router.post("/converient",async(req,res)=>{
...
router.post("/listconverient",async(req,res)=>{
...
router.post("/listOfHotels",async(req,res)=>{
